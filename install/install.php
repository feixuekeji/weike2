...
$sql10="create table if not exists favorite(
...
$sql11="create table if not exists appeal(
...
//创建表  写入数据库
if(mysql_query($sql1)&&mysql_query($sql2)&&mysql_query($sql3)&&mysql_query($sql4)&&mysql_query($sql5)&&mysql_query($sql6)&&mysql_query($sql7)&&mysql_query($sql8)&&mysql_query($sql9)&&mysql_query($sql10)&&mysql_query($sql11)&&mysql_query($sql12))
  {
	echo "<h1>数据库安装成功</h1>";
