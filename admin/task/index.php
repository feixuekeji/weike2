...
$sqlUser="select * from task order by ID desc limit {$off},{$length}";
	...
	<div class="tab-con cjhz rcb xsgl" style="height:90%;">
		...
		<div class="con">
			...
			while ($rowUser=mysql_fetch_assoc($rstUser)){
				...
				echo "<span class='col-12'><a href='stop.php?id={$rowUser['ID']}'> 停止</a> ｜ <a href='delete.php?id={$rowUser['ID']}'>删除</a></span>";
				echo "</p>";
				echo "</li>";
				echo "</ul>";
			}
