...
<div class="xsd w1020" style="height:100%;">
	<div class="title-bar">
		<span class="txt">任务类型管理</span>
	</div>
	<div class="tab-con cjhz rcb xsgl" style="height:90%;">
		<div class="date">
			
			<span class="fr"><a href="add.php" class="btn-green">添加任务类型</a></span>
		</div>
		<div class="con">
			<ul class="head">
				<li>
					<p>
						<span class="col-4">任务类型</span>
			...
			while ($rowUser=mysql_fetch_assoc($rstUser)){
				...
				echo "<li>";
				echo "<p>";
				echo "<span class='col-4'>{$rowUser['Name']}</span>";
				echo "<span class='col-12'><a href='edit.php?id={$rowUser['ID']}'>修改</a>  |  <a href='delete.php?id={$rowUser['ID']}'>删除</a></span>";
				echo "</p>";
				echo "</li>";
				echo "</ul>";
			}
