...
//获取数据列数，实现翻页
$sqlCnt="select count(*) from account";
	...
	<div class="tab-con cjhz rcb xsgl" style="height:90%;">
		...
		<div class="con">
			<ul class="head">
				<li>
					<p>
						...
						<span class="col-60">账号</span>
						<span class="col-60">支付宝账号</span>
						<span class="col-60">余额</span>
					</p>
				</li>
			</ul>
			<?php
			while ($rowUser=mysql_fetch_assoc($rstUser)){
				...
				echo "<span class='col-60'>{$rowUser['accName']}</span>";
				echo "<span class='col-60'>{$rowUser['accCardID']}</span>";
				echo "<span class='col-60'>{$rowUser['accBalance']}</span>";
				echo "</p>";
				echo "</li>";
				echo "</ul>";
			}
