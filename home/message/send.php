...
$sqlUser="select message.*,user.Username from message,user where message.SendID={$id} and message.AcceptID=User.ID order by ID desc limit {$off},{$length}";
