...
$sqlUser="select task.*,user.Username from task,user where task.UserID=user.ID order by ID desc limit {$off},{$length}";
...
<body>
    ...
    <center>
        ...
        <label>搜索：</label><input name="key" type="text" placeholder="请输入任务标题进行搜索">
