(function(){
    ...
    UM.registerWidget('link', {
        tpl: "<style type=\"text/css\">" +
			...
			"<select id=\"edui-link-Jtarget\"><option value=\"1\">是</option><option value=\"0\">否</option></select>"+
            "</td>" +
            "</tr>" +
//            "<tr>" +
        ...
        initEvent: function (editor, $w) {
            ...
            if(link){
                ...
                if($(link).attr('target') == '_blank' ){
					$('#edui-link-Jtarget option:first-child').attr('selected',true);
				}else{
					$('#edui-link-Jtarget option:last-child').attr('selected',true);
				}
            }
                ...
                exec: function (editor, $w) {
                    ...
                    if (href) {
                        editor.execCommand('link', {
                            'href': href,
                            'target': $("#edui-link-Jtarget").val()==1 ? "_blank" : '_self',
